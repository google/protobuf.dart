...
void main() {
  ...
  test('testFixed64', () {
    ...
    expect(readFixed64([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), 0);
    expect(readFixed64([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), 1);
    expect(readFixed64([0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]),
           18446744073709551615);

    final fixed64ToBytes = convertToBytes(GeneratedMessage.OF6);

    expect(fixed64ToBytes(0), [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
    expect(fixed64ToBytes(1), [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
    expect(fixed64ToBytes(18446744073709551615),
  ...
  test('testSfixed64', () {
    ...
    expect(readSfixed64([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), 0);
    expect(readSfixed64([0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]), -1);
    expect(readSfixed64([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), 1);
    expect(readSfixed64([0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]), -2);
  ...
  test('testVarint', () {
    ...
    expect(uint64ToBytes(0), [0]);
    expect(uint64ToBytes(3), [0x03]);
    expect(uint64ToBytes(0x80), [0x80, 0x01]);
    expect(uint64ToBytes(0xff), [0xff, 0x01]);
    expect(uint64ToBytes(0x9600), [0x80, 0xac, 0x02]);
    expect(uint64ToBytes(0x9e5301), [0x81, 0xa6, 0xf9, 0x04]);
    expect(uint64ToBytes(0xffffffff), [0xff, 0xff, 0xff, 0xff, 0x0f]);
    expect(uint64ToBytes(0xffffffffffffff),
           [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f]);
    expect(uint64ToBytes(0xffffffffffffffff),
           [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01]);

    readUint64(List<int> bytes) => new CodedBufferReader(bytes).readUint64();

    expect(readUint64([0x00]), 0);
    expect(readUint64([0x03]), 3);
    expect(readUint64([0x81, 0x1c]), 0x0e01);
    expect(readUint64([0x96, 0x01]), 0x96);
    expect(readUint64([0xce, 0x01]), 0xce);
    expect(readUint64([0x81, 0xa6, 0xf9, 0x04]), 0x9e5301);
    expect(readUint64([0xff, 0xff, 0xff, 0xff, 0x07]), 0x7fffffff);
    expect(readUint64([0xff, 0xff, 0xff, 0xff, 0x0f]), 0xffffffff);
