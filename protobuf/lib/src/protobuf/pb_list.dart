...
class FrozenPbList<E> extends PbListBase<E> {
  ...
  @override
  void removeWhere(bool Function(E) test) => throw _unsupported('removeWhere');
  @override
  void retainWhere(bool Function(E) test) => throw _unsupported('retainWhere');
  @override
...
class PbList<E> extends PbListBase<E> {
  ...
  /// function.
  @override
  void sort([int Function(E, E) compare]) => _wrappedList.sort(compare);
  ...
  @override
  void removeWhere(bool Function(E) test) => _wrappedList.removeWhere(test);

  /// Removes all objects from this list that fail to satisfy [test].
  @override
  void retainWhere(bool Function(E) test) => _wrappedList.retainWhere(test);
...
abstract class PbListBase<E> extends ListBase<E> {
  ...
  @override
  Iterable<T> map<T>(T Function(E) f) => _wrappedList.map<T>(f);

  /// Returns a new lazy [Iterable] with all elements that satisfy the predicate
  /// [test].
  @override
  Iterable<E> where(bool Function(E) test) => _wrappedList.where(test);

  /// Expands each element of this [Iterable] into zero or more elements.
  @override
  Iterable<T> expand<T>(Iterable<T> Function(E) f) => _wrappedList.expand(f);
  ...
  @override
  E reduce(E Function(E, E) combine) => _wrappedList.reduce(combine);
  ...
  @override
  bool every(bool Function(E) test) => _wrappedList.every(test);
  ...
  @override
  bool any(bool Function(E) test) => _wrappedList.any(test);
  ...
  @override
  Iterable<E> takeWhile(bool Function(E) test) => _wrappedList.takeWhile(test);
  ...
  /// satisfied.
  @override
  Iterable<E> skipWhile(bool Function(E) test) => _wrappedList.skipWhile(test);
